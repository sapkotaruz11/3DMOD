...
def load_real_rgbs(test_mv=3):
    obj_rgbs_folder ='./Data_sample/amazon_real_rgbs/table/'
    rgbs = []
...
def load_shapenet_rgbs(test_mv=3):
    obj_rgbs_folder = './Data_sample/ShapeNetRendering/02691156/1a888c2c86248bbcf2b0736dd4d8afe0/rendering/'
    obj_gt_vox_path ='./Data_sample/ShapeNetVox32/02691156/1a888c2c86248bbcf2b0736dd4d8afe0/model.binvox'
    rgbs=[]
    rgbs_views = sorted(os.listdir(obj_rgbs_folder))
    for v in rgbs_views:
        if not v.endswith('png'): continue
